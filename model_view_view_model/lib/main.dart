...
// View + Controller = View (MVVM)
class _MyHomePageState extends State<MyHomePage> {
  ViewModel viewModel;

  _MyHomePageState() {
    viewModel = ViewModel(didUpdateState: didUpdateState);
  }

  didUpdateState(ViewModelState state) {
    switch(state) {
      case ViewModelState.updateCounter:
        setState(() {});
        break;
      default: break;
    }
